 ...
 */
@Entity
public class TypeCarburantVoiture implements Serializable {
...
//*********** constructeurs **********//
    ...
    public TypeCarburantVoiture() {
    }

    public TypeCarburantVoiture(String nomCarburant, Voiture voiture) {
        this.nomCarburant = nomCarburant;
        this.voiture = voiture;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TypeCarburantVoiture)) {
            return false;
        }
        TypeCarburantVoiture other = (TypeCarburantVoiture) object;
